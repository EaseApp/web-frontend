angular.module('easeApp').factory('ClientService', function($http, $location, $state, $mdDialog){
	var service = { user: {} };
	var baseUrl = 'http://ease-62q56ueo.cloudapp.net';
	...
	function makeUser(data){
		...
		service.user.emailHash = MD5(data.username);
	}
